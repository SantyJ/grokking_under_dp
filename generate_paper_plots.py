...
def generate_plots():
    ...
    dp_experiment_key = "add_mod|num_epochs-20000|train_fraction-0.4|log_frequency-500|lr-0.0005|cross_entropy_dtype-float16|adam_epsilon-1e-30|use_dp-True|target_epsilon-20.0|target_delta-0.00019580967299784609"
    try:
