...
def parse_args():
    ...
    # Clipping arguments (formerly DP)
    parser.add_argument('--use_clipping', action='store_true', default=False,
                        help='Use gradient clipping. Default is False.')
    parser.add_argument('--max_grad_norm', type=float, default=1.0,
                        help='Max grad norm for clipping. Default is 1.0.')
